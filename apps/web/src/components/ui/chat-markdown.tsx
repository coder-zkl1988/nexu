...
export function getEmbeddedBrowserChatLink(href: string | null): string | null {
  if (!href || !/^https?:\/\//iu.test(href)) return null;
  return href;
}
...
export const ChatMarkdown = memo(function ChatMarkdown({
  ...
  const handleClick = useCallback(
    (event: MouseEvent<HTMLDivElement>): void => {
      ...
      const href = getEmbeddedBrowserChatLink(
  ...
  return (
    // biome-ignore lint/a11y/useKeyWithClickEvents: delegated clicks come from native anchors, whose keyboard activation also emits click
    <div
