const en = {
  ...
  "teams.board": "Board",
  "teamWorkflows.title": "Workflows (SOP)",
  "teamWorkflows.recentRun": "Recent run",
  "teamWorkflows.fromTemplate": "From template",
  "teamWorkflows.compose": "Compose",
  "teamWorkflows.empty":
    "No workflows yet. Create one from a template or let AI compose one.",
  "teamWorkflows.builtin": "Built-in",
  "teamWorkflows.stepCount": "{{count}} steps",
  "teamWorkflows.run": "Run",
  "teamWorkflows.delete": "Delete workflow",
  "teamWorkflows.errDelete": "Delete failed",
  "teamWorkflows.templateTitle": "Choose a template",
  "teamWorkflows.templateHint":
    "Experts the template needs are added to the team automatically.",
  "teamWorkflows.templateAdded": "Added to team workflows",
  "teamWorkflows.errInstantiate": "Template instantiation failed",
  "teamWorkflows.use": "Use",
  "teamWorkflows.composeTitle": "Compose a workflow",
  "teamWorkflows.composePlaceholder":
    "e.g. a weekly competitor analysis report pipeline",
  "teamWorkflows.generate": "Generate",
  "teamWorkflows.errCompose": "Compose failed — try rephrasing",
  "teamWorkflows.dependsOn": "depends on",
  "teamWorkflows.saveDraft": "Save as workflow",
  "teamWorkflows.composeSaved": "Workflow saved",
  "teamWorkflows.errSave": "Save failed",
  "teamWorkflows.runTitle": 'Run "{{name}}"',
  "teamWorkflows.errInputRequired": "Please fill in {{name}}",
  "teamWorkflows.errRun": "Failed to start",
  "teamWorkflows.start": "Start",
