const zhCN = {
  ...
  "layout.mobile.experts": "专家",
  "layout.mobile.expertsSubtitle": "将预设专家安装为机器人",
  ...
  // ── Experts ──
  "experts.title": "专家",
  "experts.subtitle": "一键安装预设专家，立即创建对应的机器人。",
  "experts.tabs.explore": "发现",
  "experts.tabs.yours": "已安装",
  "experts.search.placeholder": "搜索专家...",
  "experts.install": "安装",
  ...
  "experts.refresh": "刷新目录",
  "experts.empty.explore": "暂无专家。点击刷新获取最新目录。",
  "experts.empty.yours": "你还没有安装任何专家。",
  "experts.loading": "加载中...",
  ...
  "devices.settings.enablePluginDesc":
    "运行 lobster-device-control 插件以接受 Android 设备连接 ws://0.0.0.0:{{wsPort}}/phone",
