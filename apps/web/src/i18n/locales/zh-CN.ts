const zhCN = {
  ...
  "layout.nav.agents": "AI搭子",
  "layout.nav.devices": "设备",
  "layout.nav.settings": "设置",
  "layout.nav.experts": "AI搭子",
  "layout.mobile.experts": "AI搭子",
  "layout.mobile.expertsSubtitle": "将预设AI搭子安装为机器人",
  ...
  "experts.title": "AI搭子",
  "experts.subtitle":
    "以灵魂塑造独特个性，用技能解锁多元能力，结识只属于你的 AI 搭子",
  "experts.tabs.explore": "发现",
  "experts.tabs.yours": "已安装",
  "experts.search.placeholder": "搜索AI搭子...",
  "experts.empty.explore": "暂无AI搭子。点击刷新获取最新目录。",
  "experts.empty.yours": "你还没有安装任何AI搭子。",
  "experts.custom_create": "自定义搭子",
  "experts.custom.title": "创建定制搭子",
  "experts.custom.subtitle": "定义专属于你的 AI 搭子",
  ...
  "experts.custom.name": "搭子名称",
  "experts.custom.name_placeholder": "给你的搭子起个名字",
